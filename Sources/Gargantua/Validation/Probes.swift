...
final class Probes {
    ...
    func run(_ launches: [Launch], settings: Schwarzschild.Settings, jump: Bool = false, spin: Double = 0) -> [RayProbeResult] {
        ...
        let uniforms = MarchPass.uniforms(camera: OrbitCamera(), width: 1, height: 1, settings: settings,
                                          driftBudget: 1, redshift: false, starSeed: 0, tables: jump ? marchPass.tables : nil, spin: spin)
